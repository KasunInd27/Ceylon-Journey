...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($sql) === TRUE) {
        // Redirect to destination_home.php if the record is inserted successfully
        header('Location: destination_home.php');
...
<head>
    ...
    <link rel="stylesheet" href="css/styles.css"> <!-- Linking to the external CSS -->
</head>
<body>
