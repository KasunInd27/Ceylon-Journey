...
<div class="dashboard">
     <!-- View Destinations Card -->
    <div class="card">
        <img class="default-image" src="uploads/create.jpg" alt="View Destinations">
        <img class="hover-image" src="uploads/dashboard1.jpg" alt="View Destinations Hover">
        ...
        <div class="card-actions">
            <button onclick="window.location.href='destination_home.php';">View Destinations</button>
        </div>
    </div>

    <!-- Add New Destination Card -->
    <div class="card">
        <img class="default-image" src="uploads/destination.jpg" alt="Add New Destination">
        <img class="hover-image" src="uploads/dashboard2.jpg" alt="Add New Destination Hover">
        <div class="card-content">
