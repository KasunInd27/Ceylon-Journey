...
<div class="container">
    ...
    <div class="card-container">
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                echo "
                <div class='card'>
                    <img src='../Destination crud/uploads/" . $row['image'] . "' alt='" . $row['name'] . "'>
                    <div class='card-content'>
                        <h3 class='card-title'>" . $row['name'] . "</h3>
                        <p class='card-description'>" . $row['description'] . "</p>
                        <div class='card-actions'>
                            <a class='edit-btn' href='../Destination crud/edit_destination.php?id=" . $row['id'] . "'>Edit</a>
                            <a class='delete-btn' href='../Destination crud/delete_destination.php?id=" . $row['id'] . "'>Delete</a>
                        </div>
                    </div>
                </div>
                ";
    ...
    <a href="../Destination crud/index.php">Dashboard</a>
</div>
